---
title: python-exception-groups
description: 探索 Python Exception Groups：except* 语法、处理多个异常、异步并发异常
---
...
| 来源 | ai |
| AI 参与 | full |
| 标签 | `exception-groups` `exception` `python-3.11` |

</div>

## 描述

探索 Python Exception Groups：except* 语法、处理多个异常、异步并发异常
